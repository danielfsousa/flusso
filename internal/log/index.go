...
// Readtakes in an offset and returns the associated record’s position in the store.
...
// file and that the persisted file has flushed its content to stable storage.
